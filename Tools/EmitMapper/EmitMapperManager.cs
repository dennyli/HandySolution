...
namespace EmitMapper
{
	...
	/// </summary>
	public class EmitMapperManager
	{
		public static EmitMapperManager _defaultInstance = null;

		public static EmitMapperManager DefaultInstance
		{
			get
			{
				if (_defaultInstance == null)
				{
					lock (typeof(EmitMapperManager))
					{
						if (_defaultInstance == null)
						{
							_defaultInstance = new EmitMapperManager();
						}
					}
				}
		...
		/// <returns></returns>
		public EmitMapper<TFrom, TTo> GetMapper<TFrom, TTo>()
		{
			return new EmitMapper<TFrom, TTo>(
				GetMapperImpl(
					typeof(TFrom),
					typeof(TTo),
		...
		public EmitMapper<TFrom, TTo> GetMapper<TFrom, TTo>(IMappingConfigurator mappingConfigurator)
		{
			return new EmitMapper<TFrom, TTo>(
				GetMapperImpl(
					typeof(TFrom),
