...
namespace Utility.Exceptions
{
    ...
    {
        /// <summary>
        ///     实体化一个 Utility.BllException 类的新实例
        /// </summary>
        public BusinessException() { }

        /// <summary>
        ///     使用异常消息实例化一个 Utility.BllException 类的新实例
        /// </summary>
        ...
        /// <summary>
        ///     使用异常消息与一个内部异常实例化一个 Utility.BllException 类的新实例
        /// </summary>
        /// <param name="message">异常消息</param>
        ...
        /// <summary>
        ///     使用可序列化数据实例化一个 Utility.BllException 类的新实例
        /// </summary>
