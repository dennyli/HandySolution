...
namespace Utility
{
    ...
    {
        /// <summary>
        ///     初始化 Utility.ComponentsException 类的新实例
        /// </summary>
        public ComponentException() { }

        /// <summary>
        ///     使用指定错误消息初始化 Utility.ComponentsException 类的新实例。
        /// </summary>
        ...
        /// <summary>
        ///     使用异常消息与一个内部异常实例化一个 Utility.ComponentException 类的新实例
        /// </summary>
        ...
        /// <summary>
        ///     使用可序列化数据实例化一个 Utility.ComponentException 类的新实例
        /// </summary>
